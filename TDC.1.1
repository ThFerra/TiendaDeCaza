...
if OpUser==1:
    ...
    print()
    print("Para registrarse, el nombre de usuario debe ser las primeras 2 letras del nombre y  el rut de este sin puntos o guiones, como el ejemplo a seguir;.")
    print("th212147895")
    Nom=(input(">> "))
    Usuarios.append(Nom)
    len(Nom)
    if len(Nom)>9:
        ...
        if len(Con)>7 and len(Con)<13:
            ...
            print("Tu contraseña no está en el rango establecido.")
#Le voy a cambiar para que sea que al ingresar la contraseña equivocada sea devuelto a ingresar por primera vez la contraseña, pero esos son los cambios que hice
